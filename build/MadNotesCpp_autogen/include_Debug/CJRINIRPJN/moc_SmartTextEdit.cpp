...
void SmartTextEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->wikiLinkClicked((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (SmartTextEdit::*)(const QString & )>(_a, &SmartTextEdit::wikiLinkClicked, 0))
            return;
    }
}
...
// SIGNAL 0
void SmartTextEdit::wikiLinkClicked(const QString & _t1)
{
